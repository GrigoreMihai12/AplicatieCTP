...
const QMetaObject QtGuiApplication3::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QtGuiApplication3.data,
      qt_meta_data_QtGuiApplication3,  qt_static_metacall, nullptr, nullptr}
};
...
void *QtGuiApplication3::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtGuiApplication3.stringdata0))
        return static_cast<void*>(const_cast< QtGuiApplication3*>(this));
